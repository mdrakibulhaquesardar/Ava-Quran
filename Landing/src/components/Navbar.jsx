    ...
    <nav className="sticky top-0 z-50 bg-surface/80 backdrop-blur-md border-b border-outline-variant/10">
      <div className="flex justify-between items-center w-full px-margin-page py-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href={APP_DOWNLOAD_LINK} className="flex items-center gap-2 bg-primary text-on-primary px-6 py-2 rounded-full font-label-md text-label-md scale-95 active:scale-90 hover:shadow-md hover:bg-primary-container transition-all duration-150">
